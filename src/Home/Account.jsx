...
function Account() {
  ...
  if (!isAuthenticated) {
    // Show notification and prevent rendering content if not authenticated
    return (
      <>
        <Header />
        <div className="w-full h-fit flex flex-col mt-12 bg-gray-950 p-6">
          <p className="text-white text-center">Please login to view your account</p>
        </div>
      </>
    );
  }
