...
function Home() {
  ...
  return (
    <>
      <Header />
      <div className=" bg-gray-950 w-fir h-fit z-10  ">
        <aside
          id="default-sidebar"
          className="fixed top-20 left-0 z-10 w-44 h-screen  bg-purple-700 transition-transform -translate-x-full sm:translate-x-0"
          aria-label="Sidebar"
        >
        ...
        <div className="flex flex-wrap justify-center md:justify-start   mt-12 w-full max-w-[1096px]  ml-20 p-5 gap-3  relative left-0 md:left-[87px]">
          {data.map((video) => (
